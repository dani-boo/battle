...
describe Game do
  ...
  describe '#current_turn' do
    it 'game starts with Player 1' do
  ...
  describe '#opponent_of' do
    it 'shows the opponent of a player' do
  ...
  describe '#game_over?' do
    it 'returns false if no-one is at zero HP' do
      expect(game.game_over?).to be false
    end

     it 'returns true if at least one player is at zero HP' do
